...
function ParallaxImg(props: React.ImgHTMLAttributes<HTMLImageElement>) {
  ...
  return (
    <motion.img ref={ref} {...(props as any)} style={{ y, ...props.style }} />
  );
}
...
export default function LandingPage() {
  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth < 1024) {
        setZoomScale(window.innerWidth / 800);
      } else {
        setZoomScale(1);
      }
    };
  ...
  return (
    <SmoothScroll>
      <div
        className="bg-black min-h-screen text-white overflow-x-hidden w-screen max-w-full"
        style={{ fontFamily: SF, width: "100vw", overflowX: "hidden" }}
      >
        {/* NAVBAR */}
        <FloatingNavbar />
        ...
        <div
          ...
          style={zoomScale < 1 ? { zoom: zoomScale, width: "800px" } : {}}
        >
          {/* HERO */}
          ...
          <section className="px-4 md:px-5 py-10" id="features">
            <div className="max-w-5xl mx-auto">
              <div className="mb-12">
                <motion.h2
                  className="font-heading font-bold text-white leading-[0.98]"
                  style={{
              ...
              <div ref={featuresGridRef} className="space-y-2 bento-section">
                  ...
                  -webkit-mask-[radial-gradient(circle_at_center,white_0%,transparent_100%)]"
                    ...
                    <div className="absolute inset-x-0 top-0 z-20 p-8">
                      ...
                      <p className="font-paragraph text-gray-300 text-base  font-normal">
                        Start watching instantly with no loading delays.
                        Everything is optimized to feel smooth, fast, and
                        completely uninterrupted from the first second.
                      </p>
                    </div>
               ...
               -webkit-mask-[radial-gradient(circle_at_center,white_0%,transparent_100%)]"
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="bento-card card card--border-glow col-span-2 apple-glass min-h-[460px] relative overflow-hidden">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <ParallaxImg
          ...
          <section className="px-4 md:px-5 py-10" id="watch-parties">
            <div className="max-w-5xl mx-auto">
              ...
              <div
                ...
                className="grid grid-cols-12 gap-2 bento-section"
              >
                <GlobalSpotlight
                  ...
                  glowColor="255, 255, 255"
                />
                <div className="col-span-8 bento-card card card--border-glow apple-glass min-h-[400px] relative overflow-hidden">
                  <ParallaxImg
             ...
             -webkit-mask-[radial-gradient(circle_at_center,white_0%,transparent_100%)]"
                ...
                <div className="col-span-4 bento-card card card--border-glow apple-glass min-h-[400px] relative overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <ParallaxImg
             ...
             -webkit-mask-[radial-gradient(circle_at_center,white_0%,transparent_100%)]"
                ...
                <div className="col-span-4 bento-card card card--border-glow apple-glass min-h-[300px] relative overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <ParallaxImg
             ...
             -webkit-mask-[radial-gradient(circle_at_center,white_0%,transparent_100%)]"
                ...
                <div className="col-span-4 bento-card card card--border-glow apple-glass p-8 flex flex-col justify-between">
                ...
                <div className="col-span-6 bento-card card card--border-glow apple-glass min-h-[150px] relative overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <ParallaxImg
          ...
          <section className="px-6 md:px-8 py-10 mb-16">
            <div className="max-w-5xl mx-auto">
              <header className="mb-12">
                <motion.h2
                  className="font-heading font-bold text-white leading-[0.98] mb-4"
                  style={{
                    fontSize: "clamp(2rem, 5.5vw, 3.75rem)",
                    letterSpacing: "-0.04em",
                    fontWeight: 700,
              ...
              <div
                ref={perfGridRef}
                className="grid grid-cols-4 grid-rows-4 gap-2 auto-rows-[160px] bento-section"
              >
                <GlobalSpotlight
                  gridRef={perfGridRef}
                  enabled
                  ...
                  glowColor="255, 255, 255"
                />
                <div className="bento-card card card--border-glow apple-glass col-span-2 row-span-2 min-h-[320px] relative overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <ParallaxImg
    ...
    -webkit-mask-[radial-gradient(circle_at_center,white_0%,transparent_100%)]"
                ...
                <div className="bento-card card card--border-glow apple-glass col-span-2 row-span-1 min-h-[160px] relative overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <ParallaxImg
             ...
             -webkit-mask-[radial-gradient(circle_at_center,white_0%,transparent_100%)]"
                ...
                <div className="bento-card card card--border-glow apple-glass col-span-1 row-span-2 min-h-[320px] relative overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <ParallaxImg
             ...
             -webkit-mask-[radial-gradient(circle_at_center,white_0%,transparent_100%)]"
                ...
                <div className="bento-card card card--border-glow apple-glass col-span-1 row-span-1 min-h-[160px] relative overflow-hidden">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <ParallaxImg
