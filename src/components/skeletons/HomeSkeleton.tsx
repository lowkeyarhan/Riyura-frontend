...
export default function HomeSkeleton() {
  return (
    <div className="min-h-screen bg-black">
      {/* Banner Skeleton - Covers Full Viewport */}
      <div className="relative w-full h-[88vh] md:h-screen bg-black overflow-hidden">
          ...
          <div className="absolute inset-0 z-20">
            ...
            <div className="absolute bottom-0 left-0 w-full px-6 pb-16 md:px-20 md:pb-24 z-10">
              <div className="max-w-2xl">
                <Skeleton width={48} height={28} borderRadius={20} className="mb-4" />
                <Skeleton width="80%" height={64} className="mb-2 block" style={{ maxWidth: "500px" }} />
                <Skeleton width="50%" height={64} className="mb-4 block" style={{ maxWidth: "320px" }} />
            ...
            <div className="absolute inset-x-0 bottom-10 z-20 flex items-center justify-center gap-2 px-6 md:px-20">
              {[1, 2, 3, 4, 5].map((i) => (
                <Skeleton key={i} width={i === 1 ? 32 : 8} height={8} borderRadius={9999} />
              ))}
            </div>
          </div>
        </SkeletonTheme>
