  ...
  useEffect(() => {
    ...
    spotlight.style.cssText = `
      ...
      background: radial-gradient(circle at 50% 50%,
        ...
        rgba(${glowColor}, 0.03) 34%,
        rgba(${glowColor}, 0.012) 50%,
        rgba(${glowColor}, 0.004) 68%,
        rgba(${glowColor}, 0.0) 100%
      );
      z-index: 200;
      opacity: 0;
    ...
    <>
      <style>{`
        .bento-section {
          ...
          --border-color: #392e4e; --background-dark: #060010; --white: hsl(0, 0%, 100%);
        }
